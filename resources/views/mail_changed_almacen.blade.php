        ...
        <body>
            ...
            <div class="main">
                ...
                <p class="font-weight-bold">Procedemos a enviarle este correo electronico para informarle
                    <br>
                    sobre el cambio de almacen del producto "{{$producto->nombre}}" del almacen
                    {{$almacen_antiguo->nombre}} en la isla {{$almacen_antiguo->isla}} a este almacen {{$producto->almacene->nombre}} esperamos que la llegada del producto sea notificada</p>
