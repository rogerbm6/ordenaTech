        ...
        <body>
            ...
            <div class="main">
                ...
                <p class="font-weight-bold">Procedemos a enviarle este correo electronico para informarle
                    ...
                    con código<br>
                    postal
                    {{$almacen_nuevo->cp}}, por favor envie el producto lo antes posible y compruebe en el sistema</p>
                <br>
                <br>
                <h2 class="font-weight-bold">Envie los productos con este Numero de serie</h2>
                <ul class="list-unstyled p-2" style="list-style: none; margin-right: 3%;">
                    <div class="row">
                        ...
                        <div>
                            ...
                            <p>
                                <li>
                                    {{$unidad->numero_serie}}<em>({{$unidad->estado}})</em><br>
                                </li>
                            </p>
                ...
                <div class="m-2">
                    ...
                    <p class="font-weight-bold">Producto
                        {{$producto->nombre}}<br>
                        Part Number: {{$producto->part_number}}<br>
                    ...
                    <h4 class="font-weight-bold">Fecha:
                        {{date("d-m-Y")}}</h4>
                </div>
