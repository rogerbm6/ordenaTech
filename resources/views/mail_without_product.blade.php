        ...
        <body>
            ...
            <div class="main">
                ...
                <p class="font-weight-bold">Procedemos a enviarle este correo electronico para informarle
                    <br>
                    sobre la salida del producto "{{$producto->nombre}}" del almacen almacen
                    {{$producto->almacene->nombre}}, -en la actualidad no disponemos de este-</p>
