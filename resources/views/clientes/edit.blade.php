    ...
    <div class="offset-md-3 col-md-6">
        <div class="card">
            ...
            <div class="card-body" style="padding:30px">
                <form method="post" action="{{route('clientes.show', $cliente->id)}}" enctype="multipart/form-data">
                    @csrf
                    {{ method_field('PUT') }}
                    ...
                    <fieldset class="form-group">
                      <label for="tipo">Tipo</label>
                        <select class="custom-select" name="tipo" value="{{$cliente->tipo}}">
                            <option selected value="{{$cliente->tipo}}">Escoge un Tipo</option>
